...
const level1 = new Level({
  ...
  enemies: [
    ...
    { type: "spider", x: 1380, yOffset: -75 },
    { type: "spider", x: 1980, yOffset: -75 },
    { type: "wolf", x: 3500, y: 298 },
  ],
  backgroundLayers: [
  ...
  tiles: [
    ...
    {
      imagePath: "img/tiles/small_spikes2.png",
      x: 2053,
      y: 380,
      width: 121,
      height: 63,
      trap: {
        damage: 10,
        hitbox: { offsetX: 25, offsetY: 8, width: 74, height: 46 },
      },
    },
